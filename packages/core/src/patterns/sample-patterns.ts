export const SamplePatterns = [
  ...
  },
  {
    ...
    severity: "HIGH",
    what_happened:
      "Your function is not exposed as an external contract entrypoint.",
    why_cairo_specific:
      "Unlike Solidity's public keyword, Cairo requires explicit ABI embedding using #[abi(embed_v0)] to expose functions externally.",
